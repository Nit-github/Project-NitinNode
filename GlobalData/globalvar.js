...
window.onload = (function(){ document.getElementById("loader").src="https://thumbs.gfycat.com/MarriedMarvelousHawaiianmonkseal-small.gif";});
const emailtepmlate=/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;
